...
O Normal Q-Q plot, na fig-qqplot, mostra os resíduos estão próximo da reta.
...
Nessa alternativa, um intervalo de confiança é traçada em torno da reta para demarcar o limite de desvios toleráveis, assim, as observações de dados normalmente distribuídos devem se mater dentro do intervalo.

Os dados se mantém dentro do intervalo de confiança, de forma que que se concluem qoe o pressuposto de normalidade dos resíduos foi atendido
...
No resultado do função, BP corresponde à estística de teste e o seu correspondente valor P = 0.7895, por ser superior 0,05, é não é significante, de forma que não se pode rejeitar a hipótese nula e indica homocedasticidade.
...
O gráfico não revela padrões restantes nos resíduos e a linha vermelha, apesar do leve vale em X=7, é razoavelmente horizontal, de forma que não há indícios de violação da linearidade. O três números destacados (1, 3 e 11) indicam três maiores resíduos, mas não são necessariamente atípicos (*outliers*).
...
O gráfico não revela suspeita de dispersão, pois a linha vermelha não exibe tendência, portanto, é apesar não não haver indícios de dispersão heterôgenea grave dos resíduos, é prudente incluir um teste formal na análise, o qual já foi realizado pelo teste de Breusch-Pagan anteriormente.
